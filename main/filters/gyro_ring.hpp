...
struct sample {
    ...
    union U {
        ...
        U(const U& other){memcpy((void*)this, (const void* )&other, sizeof(U));}
        raw_sample raw;
        quat::quat quat;
    } sample2;
    uint8_t content{};
   ...
   public:
    ...
    WorkResult Work() {
        ...
        while (rptr_ != cached_wptr) {
            ...
            s.sample2.quat = quat_rptr_; // TODO
        ...
        while (samples_buffered) {
            ...
            {  // Interpolate
                ...
                quat::quat q = ring_[sptr_].sample2.quat * k1 +
                               ring_[next_sptr].sample2.quat * k2;
