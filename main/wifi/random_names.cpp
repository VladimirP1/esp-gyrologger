...
std::string random_name(int seed) {
    static const std::initializer_list<const char*> names_left = {
        "admiring",      "adoring",   "affectionate", "agitated",   "amazing",       "angry",
        "awesome",       "beautiful", "blissful",     "bold",       "boring",        "brave",
        "busy",          "charming",  "clever",       "cool",       "compassionate", "competent",
        "condescending", "confident", "cranky",       "crazy",      "dazzling",      "determined",
        ...
        "intelligent",   "jolly",     "jovial",       "keen",       "kind",          "laughing",
    ...
    static const std::initializer_list<const char*> names_right = {
        ...
        "ride",       "ritchie",       "rhodes",      "robinson",   "roentgen",
    ...
    int count_left = std::distance(names_left.begin(), names_left.end());
    int count_right = std::distance(names_right.begin(), names_right.end());
    return *(names_left.begin() + ((seed * 13) % count_left)) + std::string{"_"} +
           *(names_right.begin() + ((seed * 7) % count_right));
}