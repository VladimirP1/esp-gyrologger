...
static const std::initializer_list<Setting> kSettingDescriptor = {
    ...
    {"accel_grav_tol", "Accel gravity tolerance", 1.0, 200.0, 40.0},
    {"accel_gain", "Accel gain", 0.0, 1.0, 0.0005},
    ...
    {"a_pt_count", "Accel PT?", 0.0, 3.0, 1.0},
    {"a_pt_cutoff", "Accel PT? cutoff", 0.1, 500.0, 100.0},
